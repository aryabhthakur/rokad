...
const Hero: FunctionComponent<HeroProps> = ({ className, HeroTitle, HeroDesc, HeroSubTitle }) => {
    return (<>
        <section className={cn("relative flex", className)}>
            <div className="border-y border-dashed h-[640px] w-full top-40 left-0 absolute border-neutral-300" />
                ...
                <div className="h-[640px] border-y border-dashed border-neutral-300 p-1 relative">
                    <div className="bg-white rounded h-full text-center relative z-10 p-5">
                        ...
                        <div className="relative flex  flex-col justify-center h-full items-center">
                            <span className="border-2 bg-white w-fit text-sm rounded-full font-medium py-1 px-3">
                                Backend by Real-time Data & Multi-model AI
                            </span>
                            <h1 className="text-7xl mt-5 font-semibold mb-2">
                                {HeroTitle}
                            </h1>
                            <p className="mb-8">
                                {HeroSubTitle}
                            ...
                            <div className="flex mt-5 gap-4">
                                <Button className="w-fit !pl-6 bg-orange-600 hover:bg-orange-800" asChild size={"lg"}>
                                    <Link href={"#hello"}>
                                        Learn more <ChevronRight />
                                    </Link>
                                </Button>
                                <Button className="w-fit pl-6!" variant={"outline"} asChild size={"lg"}>
