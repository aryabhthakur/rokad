    ...
    return (<section className={cn("bg-white border-y border-dashed border-neutral-300", className)}>
        <div className="max-w-6xl border-x pt-40 border-dashed border-neutral-300 mx-auto">
            <div className="max-w-5xl mx-auto mb-10">
                ...
                <h2 className="text-8xl mt-4 font-semibold"><span className="font-thin italic">The</span> Insights</h2>
            ...
            <div className="mt-20">
                ...
                <div className="border-t border-dashed border-neutral-300 p-2">
                    <div className="grid grid-cols-2 gap-10 p-20 bg-neutral-100 rounded">
                        <div>
                            <BadgeInfo size={46} strokeWidth={1.5} />
                            <h3 className="text-4xl font-medium mb-2 mt-5">
                                We publish weekly.
                            </h3>
                        ...
                        <div className="flex flex-col items-end justify-center">
                            <Button asChild className="pl-5! mt-4">
                                <Link href={"/insights"}>
