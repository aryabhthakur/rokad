    ...
    return (<>
        <section className={cn("flex flex-col relative overflow-hidden", className)}>
            <div className="relative z-20 max-w-6xl w-full  mx-auto py-20 border-dashed border-x border-neutral-300">
                <div className="mx-auto grid md:grid-cols-2 divide-x divide-dashed divide-neutral-300 *:p-10 *:md:p-20 border-dashed border-t border-neutral-300">
                    <div>
                        <Image src={"/india.svg"} alt="India Map" width={64} height={64} />
                        <h3 className="text-3xl md:text-6xl font-semibold md:leading-18">Nationwide Presence</h3>
                        <h5 className="text-xl mt-4">Scale with precision — not guesswork.</h5>
                    </div>
                    <div>
                        <p className="text-neutral-500 max-sm:text-sm">
                ...
                <div className="border-t border-dashed border-neutral-300">
                    <div className="text-neutral-500">
                        <div className="py-3 md:text-xl px-8 border-b border-dashed border-neutral-300">
                            Our presence spans:
                        </div>
                        <div className="text-black *:p-4 font-medium grid md:grid-cols-3 text-sm max-sm:divide-y md:divide-x divide-dashed divide-neutral-300 *:border-b *:border-dashed *:border-neutral-300 *:flex  *:items-start *:gap-1 *:bg-white space-y-1 *:h-48 *:flex-col">
                            <div>
                        ...
                        <div className="py-3 md:text-center px-8 border-b border-dashed border-neutral-300">
