...
const RIR: FunctionComponent<RIRProps> = ({ className, counter, CounterSectionSubTitle, CounterSectionTitle, CounterSectionDesc }) => {
    ...
    return (<>
        <section className={cn("px-2 md:px-8", className)}>
            <div className="bg-white rounded-3xl py-20 md:py-40">
                <div className="max-w-5xl mx-auto max-sm:px-5 mb-10">
                    <span className="border-2 flex items-center max-sm:text-sm w-fit rounded-full font-medium py-1 px-3">
                        The Model
                    </span>
                    <h2 className="md:text-8xl text-4xl mt-4 font-semibold">{CounterSectionTitle}</h2>
                    <div className="grid mt-10 md:mt-20 md:grid-cols-2 gap-5">
                        <div>
                            <h3 className="opacity-75 text-lg md:text-2xl">{CounterSectionSubTitle}</h3>
                        </div>
                        <div>
                ...
                <div className="max-w-5xl grid md:grid-cols-2 gap-2 mt-10 max-sm:px-5 md:mt-20 mx-auto">
